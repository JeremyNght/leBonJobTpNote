...
final class Version20230206130433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, job_id INT DEFAULT NULL, created_at DATETIME NOT NULL, department VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, zipcode VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, company VARCHAR(255) NOT NULL, contact_email VARCHAR(255) NOT NULL, reference VARCHAR(255) NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, INDEX IDX_29D6873EBE04EA9 (job_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
